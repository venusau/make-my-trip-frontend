      ...
      <form onSubmit={handleSearch} className="bg-light p-4 rounded shadow">
        <div className="row g-3">
          <div className="col-md-3">
            <label style={{color:"black "}} htmlFor="city" className="form-label">City</label>
            <input
              type="text"
          ...
          <div className="col-md-3">
            <label style={{color:"black "}} htmlFor="checkInDate" className="form-label">Check-In Date</label>
            <input
              type="date"
              className="form-control"
              id="checkInDate"
          ...
          <div className="col-md-3">
            <label style={{color:"black "}} htmlFor="checkOutDate" className="form-label">Check-Out Date</label>
            <input
              type="date"
              className="form-control"
              id="checkOutDate"
          ...
          <div className="col-md-3">
            <label style={{color:"black "}} className="form-label">Rooms & Guests</label>
            <input type="text" className="form-control" placeholder="1 Room, 2 Adults" readOnly />
          </div>
        </div>
            ...
            <div key={hotel._id} className="col-md-4 mb-4">
              <div className="card h-100" onClick={() => clickHandlerForHotelCard(hotel)}>
                ...
                <div className="card-body">
                  ...
                  <a href={hotel.website} target="_blank" rel="noopener noreferrer" className="btn btn-outline-primary">Visit Website</a>
                </div>
              </div>
            </div>
          ))}
